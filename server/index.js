...
// Login
app.post('https://speed-to-prof-2.onrender.com/api/login', (req, res) => {
...
app.get('https://speed-to-prof-2.onrender.com/api/questions/self-rating/:email', (req, res) => {
...
app.get('https://speed-to-prof-2.onrender.com/api/questions/test/:email', (req, res) => {
    const { email } = req.params;
    const userScenario = SCENARIOS[email];
    if (!userScenario) return res.status(404).json({ error: 'User not found' });
...
app.get('https://speed-to-prof-2.onrender.com/api/questions/subjective/:email', (req, res) => {
    const { email } = req.params;
    const userScenario = SCENARIOS[email];
    if (!userScenario) return res.status(404).json({ error: 'User not found' });
...
app.post('https://speed-to-prof-2.onrender.com/api/submit-assessment', (req, res) => {
...
app.get('https://speed-to-prof-2.onrender.com/api/assessment-sources/:email', (req, res) => {
    const { email } = req.params;
    const userScenario = SCENARIOS[email];
    if (!userScenario) return res.status(404).json({ error: 'User not found' });
...
// Get Dashboard Data
app.get('https://speed-to-prof-2.onrender.com/api/dashboard/:email', (req, res) => {
    const { email } = req.params;
    const userScenario = SCENARIOS[email];
    if (!userScenario) return res.status(404).json({ error: 'User not found' });
...
app.post('https://speed-to-prof-2.onrender.com/api/evaluate-subjective', async (req, res) => {
